...
public class aa extends JFrame {
	...
	public aa() {
		...
		add(coffeeMachinePanel, BorderLayout.CENTER); // 커피 자판기 시뮬레이션, 재료 통을 보여주는 패널
		add(new ButtonPanel(), BorderLayout.SOUTH); //3 종류의 커피 선택 버튼과 "Reset" 버튼을 가진 패널
	...
	class ButtonPanel extends JPanel {
		JButton [] coffeeButtons = new JButton[4]; // 3 개의 커피 선택 버튼과 "Reset" 버튼
		String [] names = {"Black Coffee", "Sugar Coffee", "Dabang Coffee", "Reset"}; //버튼 문자열 배열
	...
	class CoffeeMachinePanel extends JPanel {
		BoxLabel [] boxes = new BoxLabel[5]; // 5 개의 재료통을 표현하는 레이블 컴포넌트 배열
		JLabel coffeeImageLabel; // 커피가 나왔을 때 이를 보여주는커피잔 이미지 레이블
